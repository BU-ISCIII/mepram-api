...
sudo mkdir -p /srv/containers/bind/mepram-omop-api/settings
sudo mkdir -p /var/log/local/mepram-omop-api/apps
sudo mkdir -p /var/log/local/mepram-omop-api/apache
